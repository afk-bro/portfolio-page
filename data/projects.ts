...
export const projects: Project[] = [
  {
    ...
    summary: 'A full-stack e-commerce solution with real-time inventory management and payment processing.',
    description: 'Built a complete e-commerce platform from scratch, featuring product catalog, shopping cart, checkout flow, and admin dashboard.',
    ...
    caseStudy: {
      ...
      solution: 'Built a Next.js application with server-side rendering for SEO, real-time inventory updates via WebSockets, and Stripe integration for payments.',
      architecture: 'Next.js frontend, PostgreSQL database with Prisma ORM, Redis for caching and real-time updates, deployed on Vercel.',
      keyFeatures: [
      ...
      tradeoffs: 'Chose PostgreSQL over MongoDB for stronger data consistency, accepting slightly more complex schema migrations.',
      reflection: 'Would implement GraphQL for more efficient data fetching in v2. The REST API works but can over-fetch data in some scenarios.',
    },
  },
  {
    id: '2',
    ...
    slug: 'ai-code-review',
    summary: 'An AI-powered tool that automatically reviews pull requests and suggests improvements.',
    description: 'Developed an intelligent code review system using LLMs to analyze code changes, detect potential bugs, and suggest best practices.',
  ...
  },
  {
    ...
    summary: 'Unified monitoring dashboard for CI/CD pipelines, deployments, and infrastructure health.',
    description: 'Created a centralized dashboard that aggregates data from GitHub Actions, AWS, and Datadog to provide a single pane of glass for DevOps operations.',
