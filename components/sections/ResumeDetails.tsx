  ...
  return (
    <div className="card p-6">
        ...
        <div className="space-y-6">
          <div>
            <div className="flex items-baseline justify-between mb-1">
              <h4 className="font-medium text-neutral-900 dark:text-neutral-50">Senior Software Engineer</h4>
              <span className="text-sm text-neutral-500">2022 – Present</span>
            </div>
            <p className="text-sm text-neutral-500 dark:text-neutral-400 mb-2">Company Name</p>
            <ul className="text-sm space-y-1">
              <li>• Led development of customer-facing platform serving 100K+ users</li>
              <li>• Established testing practices, improving coverage from 40% to 90%</li>
              <li>• Designed and implemented CI/CD pipelines reducing deploy time by 60%</li>
            </ul>
          </div>
          <div>
            <div className="flex items-baseline justify-between mb-1">
              <h4 className="font-medium text-neutral-900 dark:text-neutral-50">Software Engineer</h4>
              <span className="text-sm text-neutral-500">2020 – 2022</span>
            </div>
            <p className="text-sm text-neutral-500 dark:text-neutral-400 mb-2">Previous Company</p>
            <ul className="text-sm space-y-1">
              <li>• Built real-time data processing pipelines handling 1M+ events/day</li>
              <li>• Migrated legacy systems to modern React/TypeScript stack</li>
      ...
      <CollapsibleSection title="Education">
        <div>
          <div className="flex items-baseline justify-between mb-1">
            <h4 className="font-medium text-neutral-900 dark:text-neutral-50">B.S. Computer Science</h4>
            <span className="text-sm text-neutral-500">2016 – 2020</span>
          </div>
          <p className="text-sm text-neutral-500 dark:text-neutral-400">University Name</p>
        </div>
      </CollapsibleSection>
