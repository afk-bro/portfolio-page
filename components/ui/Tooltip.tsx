...
export function Tooltip({
  ...
  const arrowClasses = {
    ...
    bottom: 'bottom-full left-1/2 -translate-x-1/2 border-b-neutral-800 dark:border-b-neutral-700 border-x-transparent border-t-transparent',
    ...
    right: 'right-full top-1/2 -translate-y-1/2 border-r-neutral-800 dark:border-r-neutral-700 border-y-transparent border-l-transparent',
  }
