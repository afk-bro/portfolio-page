...
function ToastItem({ toast, onClose }: ToastItemProps) {
  ...
  const styles = {
    success:
      "bg-success-50 dark:bg-green-900/30 border-success-500 dark:border-green-700 text-success-600 dark:text-green-200",
    error:
      "bg-error-50 dark:bg-red-900/30 border-error-500 dark:border-red-700 text-error-600 dark:text-red-200",
    info: "bg-blue-50 dark:bg-blue-900/30 border-blue-500 dark:border-blue-700 text-blue-600 dark:text-blue-200",
    warning:
      "bg-warning-50 dark:bg-amber-900/30 border-warning-500 dark:border-amber-700 text-warning-600 dark:text-amber-200",
  };
  ...
  return (
    ...
    >
      <Icon
        className={`w-5 h-5 flex-shrink-0 ${iconStyles[toast.type]}`}
        aria-hidden="true"
      />
