  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'cta-glow': '0 0 0 1px rgba(237, 174, 95, 0.35), 0 12px 26px rgba(191, 97, 27, 0.28)',
        'cta-glow-hover': '0 0 0 1px rgba(237, 174, 95, 0.5), 0 16px 32px rgba(191, 97, 27, 0.35)',
        // Inner keycap shadows for 3D buttons
        'keycap-inset': 'inset 0 1px 0 rgba(255, 255, 255, 0.2), inset 0 -2px 0 rgba(0, 0, 0, 0.15)',
