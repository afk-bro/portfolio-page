...
**Reality:** ProtonMail (or Gmail, or any inbox) is just where you _receive_ email. Resend domain verification is purely DNS records at the registrar. Email Routing forwarding destination can be any email address regardless of provider.
